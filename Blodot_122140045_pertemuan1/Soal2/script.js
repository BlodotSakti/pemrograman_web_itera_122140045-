...
// Event handler untuk tombol pangkat (^)
...
// Event handler untuk tombol akar (√)
document.getElementById("btn-akar").addEventListener("click", function() {
    ...
    if (isNaN(angka1)) {
        ...
        const hasil = hitungKalkulator(angka1, null, "akar"); // Angka2 tidak digunakan
        document.getElementById("hasil-kalkulator").innerHTML = 
            `<p>Hasil: √${angka1} = ${hasil}</p>`;
    }
});

// Event handler untuk tombol modulus (%)
